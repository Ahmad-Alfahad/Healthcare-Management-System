...
class UpdateDoctorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'qualification'         => 'sometimes|string|max:255|regex:/^[\pL\s]+$/u',
            'years_of_experience'   => 'sometimes|integer|min:0|numeric|max:60|digits_between:1,2',
    ...
    public function messages(): array
    {
        return [
            ...
            'qualification.regex'    => 'The doctor qualification may only contain letters and spaces.',
